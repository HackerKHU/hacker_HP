...
관리자 승격 **실패** 시도 (#144). 성공한 조작은 `admin_actions`에 남는다 — 목적도 보존 주기도 달라 섞지 않는다.
...
**시도 횟수를 제한한다** (MUST, #144). 한 계정이 **15분에 5회** 실패하면 그 계정은 같은 창 동안 막히고, 이 경로 전체가 **15분에 20회** 실패해도 막힌다. 계정을 갈아타며 두드리는 것을 전체 상한이 막는다.
...
**승격에 성공하면 그 계정의 실패 기록을 지운다** (MUST). 토큰을 몇 번 잘못 붙여넣고 성공하는 것은 흔한 일이라, 남겨 두면 **바로 다음 사고의 복구가 막힌다.**
