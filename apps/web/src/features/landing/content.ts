...
export const ACTIVITIES: Activity[] = [
  /*
   * 보안 스터디를 따로 두지 않고 소모임 안에 흡수했다.
   *
   * 소모임 6개를 각각 항목으로 만들면 활동 섹션이 9개가 되어 랜딩이 소개가 아니라
   * 목록이 된다. 보안 스터디만 따로 두는 것도 맞지 않는다 — 다른 소모임에도 나름의
   * 운영 방식이 있을 텐데 우리가 아는 것만 특별 대우하는 셈이다.
   *
   * 대신 구체적인 예가 하나는 있어야 소모임이 실제로 돌아간다는 것이 읽히므로,
   * 보안 스터디의 운영 방식을 예시로 남겼다.
   */
  {
    src: '',
    alt: '',
    title: '소모임',
    note: '관심사가 맞는 부원끼리 모여 활동합니다. 현재 언리얼엔진 스터디, 인공지능 스터디, 보안 스터디, 볼링, 롤·롤체, 스포츠 6개가 운영 중이며 원하는 분야가 있으면 직접 개설할 수 있습니다. 예를 들어 보안 스터디는 매주 화요일 저녁 디스코드에서 모여 워게임 문제를 풀고 Write-up을 공유하는데, 매주 참석이 필수는 아닌 자율 참여입니다.',
  },
  {
    src: '',
    alt: '',
    title: '교육과 멘토멘티',
    note: '신입생을 대상으로 교육을 엽니다. 1학기는 파이썬, 2학기는 C++입니다. 멘토와 멘티가 조를 이뤄 전공 스터디를 함께합니다.',
  },
  {
    src: '',
    alt: '',
