...
| 종류 | 폭 | 화면 | 왜 |
|---|---|---|---|
| 읽는 글 | `max-w-2xl` (672px) | 공지 상세, 공지 작성·수정, 개인정보처리방침, 랜딩 소개·후원 | 한글은 전각이라 글자 폭이 폰트 크기와 비슷하다. 672px이면 16px 본문에서 42자, 14px에서 48자로 편안한 줄 길이(35~45자 안팎) 안이다. 전체폭이면 82자가 되어 **눈이 다음 줄 시작을 못 찾는다** |
